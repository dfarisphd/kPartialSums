...
[ 28 ] ********************************************************************
[ 28 ] *** [[ K-PARTIAL-SUMS ( kPartialSums( 28 ) ) ]] *** CORE ALGORITHM
[ 28 ] ***    targetSum: [[ 55 ]]
[ 28 ] ***    maxNum permutations (!): [[ 268,435,456 ]]
[ 28 ] ***    NUMBER OF MATCHES (targetSum matched in InputArray): [[ 5,309 ]]
[ 28 ] ********************************************************************
[ 28 ] TIME//SCALABILITY BENCHMARK ONLY:  40.6913
[ 28 ] ********************************************************************

[ 32 ] ********************************************************************
[ 32 ] *** [[ K-PARTIAL-SUMS ( kPartialSums( 32 ) ) ]] *** CORE ALGORITHM
[ 32 ] ***    targetSum: [[ 255 ]]
[ 32 ] ***    maxNum permutations (!): [[ 4,294,967,296 ]]
[ 32 ] ***    NUMBER OF MATCHES (targetSum matched in InputArray): [[ 31,172,586 ]]
[ 32 ] ********************************************************************
[ 32 ] TIME//SCALABILITY BENCHMARK ONLY:  696.912
[ 32 ] ********************************************************************
```
